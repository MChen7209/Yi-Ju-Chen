...
public class ColoredGUISkin : MonoBehaviour {
	...
	public void UpdateGuiColors(Color color, Color secondaryColor) {
		...
		actualSkin.button.fontSize = 30;
		actualSkin.button.font = customSkin.font;
		...
		actualSkin.window.font = customSkin.font;
		...
		actualSkin.textField .font = customSkin.font;
		...
		actualSkin.box.fontSize = 30;
		actualSkin.box.font = customSkin.font;
		...
		actualSkin.label.font = customSkin.font;
