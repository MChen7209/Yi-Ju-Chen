...
public class LightningGUI : MonoBehaviour {
	...
	void OnGUI(){
		...
		if (isCooldown == false)
		{
			GUILayout.BeginArea (new Rect (90, 7 * Screen.height / 8, 100, 100));
		...
		else
		{
			...
			GUI.Label (new Rect (107, 7 * Screen.height / 8 + 10, 100, 100), cooldownDisplay, myStyle);
		}//end else
